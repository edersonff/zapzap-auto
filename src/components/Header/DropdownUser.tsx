...
const DropdownUser = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        <ul className="flex flex-col gap-52 border-b border-stroke px-6 py-4 dark:border-strokedark">
          <li>
            <Link
              href="/profile"
        ...
        <Link
          href="/logout"
          className="flex items-center gap-3.5 px-6 py-4 text-xs font-medium duration-300 ease-in-out hover:text-primary"
        >
